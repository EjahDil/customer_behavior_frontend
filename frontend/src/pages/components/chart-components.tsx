...
const ChartComponentGeneral = () => {
  ...
  const fetchChartData = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get('http://127.0.0.1:8000/api/v1/data/general_spending', {
        params: {
      ...
      setError('Data fetch fail due to poor date selection!');
    } finally {
      setLoading(false);
    }
  };
...
export default ChartComponentGeneral;
